...
<p>
  ...
  <img src="https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20Docker-green.svg" alt="Platform">
...
```bash
# 添加执行权限并运行
chmod +x rce-hawkeye && ./rce-hawkeye web -p 8080

# 安装为系统服务
sudo ./install.sh && systemctl start rce-hawkeye
```
