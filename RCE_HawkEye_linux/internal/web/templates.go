    ...
    <main class="main-content">
            ...
            <div class="scanner-layout">
                <div class="scan-config-panel glass-card">
                    ...
                    <div class="config-content">
                        <div class="config-section">
                            <div class="config-section-header">
                                ...
                                <span data-i18n="config.targetSettings">Target Settings</span>
                            </div>
                            <div class="config-section-body">
                                <div class="form-group">
                                    <label data-i18n="scan.targetUrl">Target URL</label>
                                    <div class="input-with-action">
                                        <input type="text" id="targetUrl" class="input-field" placeholder="http://example.com/vuln.php?id=1">
                                        <button type="button" class="btn-icon" onclick="parseTargetUrl()" title="Parse URL">
                                ...
                                <div class="form-row">
                                    <div class="form-group flex-2">
                                        <label data-i18n="target.urlFile">URL List (one per line)</label>
                                        <textarea id="urlFile" class="input-field textarea" rows="3" placeholder="http://example1.com&#10;http://example2.com"></textarea>
                                    </div>
                                    <div class="form-group flex-1">
                                        <label data-i18n="target.fileUpload">Or Upload File</label>
                                        <input type="file" id="urlsFile" class="input-field" accept=".txt,.csv" onchange="handleURLsFile(this)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="config-section">
                            <div class="config-section-header">
                                ...
                                <span data-i18n="config.scanSettings">Scan Settings</span>
                            </div>
                            <div class="config-section-body">
                                ...
                                <div class="form-row-3">
                                    ...
                                    <div class="form-group">
                                        <label data-i18n="scan.delayThreshold">Delay Threshold (s)</label>
                                        <input type="number" id="delayThreshold" class="input-field" value="4" step="0.5" min="1" max="30">
                                    </div>
                                    <div class="form-group">
                                        <label data-i18n="scan.retries">Retries</label>
                                        <input type="number" id="retries" class="input-field" value="2" min="0" max="5">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="config-section">
                            <div class="config-section-header">
                                ...
                                <span data-i18n="config.scanOptions">Scan Options</span>
                            </div>
                            <div class="config-section-body">
                                <div class="checkbox-grid-3">
                                    ...
                                    <label class="checkbox-label">
                                        ...
                                        <span data-i18n="option.followRedirect">Follow Redirect</span>
                                    </label>
                                    <label class="checkbox-label">
                                        <input type="checkbox" id="optAutoDetect">
                                        <span data-i18n="option.autoDetect">Auto Detect Tech Stack</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="progressSection" class="progress-section" style="display: none;">
                        ...
                        <div class="scan-terminal glass-card">
                            <div class="terminal-header">
                                <div class="terminal-title">
                                    ...
                                    <span data-i18n="scan.terminal">Scan Terminal</span>
                                </div>
                                <button class="terminal-clear" onclick="clearScanLog()">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>
                                </button>
                            </div>
                            <div class="terminal-body" id="scanTerminal">
                                <div class="terminal-line info">[INFO] Ready to scan...</div>
                            </div>
                        </div>
                    </div>
                    
                    <div class="config-actions">
                        <button type="button" class="btn-secondary" onclick="resetScanForm()">
                        ...
                        <button type="button" class="btn-secondary" onclick="saveScanSettings()">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>
                            <span data-i18n="common.saveSettings">Save Settings</span>
                        </button>
                        <button type="button" class="btn-primary" id="startScanBtn" onclick="startScan()">
            ...
            <div class="exploit-container">
                ...
                <div class="exploit-main">
                    <div class="exploit-tabs">
                        ...
                        <button class="exploit-tab" onclick="showExploitTab('encoder', event)" data-i18n="config.encoder">Encoder</button>
                    ...
                    <div id="exploit-encoder" class="exploit-panel">
                        <div class="encoder-container glass-card">
                            <div class="encoder-header">
                                <h3 data-i18n="config.encoder">Encoder / Decoder</h3>
                            </div>
                            <div class="encoder-body">
                                <div class="form-group">
                                    <label data-i18n="encoder.encoding">Encoding Options</label>
                                    <div class="checkbox-grid">
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="url" checked> URL Encode</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="double_url"> Double URL</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="base64"> Base64</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="hex"> Hex</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="unicode"> Unicode</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="html"> HTML Entity</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="octal"> Octal</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitEncoding" value="json"> JSON Escape</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label data-i18n="encoder.bypass">WAF Bypass Techniques</label>
                                    <div class="checkbox-grid">
                                        <label class="checkbox-label"><input type="checkbox" name="exploitBypass" value="case"> Case Variation</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitBypass" value="comment"> Comment Injection</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitBypass" value="nullbyte"> Null Byte</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitBypass" value="double_write"> Double Write</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitBypass" value="chunked"> Chunked Encoding</label>
                                        <label class="checkbox-label"><input type="checkbox" name="exploitBypass" value="hpp"> HTTP Param Pollution</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label data-i18n="encoder.tool">Encoding Tool</label>
                                    <div class="encoder-tool">
                                        <textarea id="exploitEncoderInput" class="input-field textarea" rows="4" placeholder="Enter text to encode/decode"></textarea>
                                        <div class="encoder-actions">
                                            ...
                                            <button type="button" class="btn-small" onclick="encodeText('html')">HTML</button>
                                            ...
                                            <button type="button" class="btn-small" onclick="decodeText('hex')">Hex Decode</button>
                                        </div>
                                        <textarea id="exploitEncoderOutput" class="input-field textarea" rows="4" placeholder="Output" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="history-toolbar">
                <div class="history-select-all">
                    <label class="checkbox-label">
                        ...
                        <span data-i18n="history.selectAll">Select All</span>
                    </label>
                </div>
            </div>
        ...
        <section id="settingsSection" style="display: none;">
            <div class="settings-tabs">
                ...
                <button class="settings-tab" onclick="showSettingsTab('http', event)" data-i18n="config.http">HTTP</button>
                <button class="settings-tab" onclick="showSettingsTab('payloads', event)" data-i18n="config.payloads">Payloads</button>
                <button class="settings-tab" onclick="showSettingsTab('advanced', event)" data-i18n="config.advanced">Advanced</button>
            ...
            <div class="settings-container">
                ...
                <div id="settings-http" class="settings-panel">
                    <div class="settings-card glass-card">
                        <div class="settings-card-header">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/></svg>
                            <h3 data-i18n="config.http">HTTP Settings</h3>
                        </div>
                        <div class="settings-card-body">
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="http.method">Default Method</label>
                                    <select id="settingsHttpMethod" class="input-field">
                                ...
                                <div class="setting-item">
                                    ...
                                    <input type="number" id="settingsDelayThreshold" class="input-field" value="4" step="0.5">
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    <label data-i18n="http.headers">Custom Headers</label>
                                    <textarea id="settingsHttpHeaders" class="input-field textarea" rows="4" placeholder="Authorization: Bearer token&#10;X-Custom-Header: value"></textarea>
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="http.userAgent">User-Agent</label>
                                    <select id="settingsUserAgentSelect" class="input-field" onchange="setSettingsUserAgent(this.value)">
                                ...
                                <div class="setting-item">
                                    <label>&nbsp;</label>
                                    <input type="text" id="settingsHttpUserAgent" class="input-field" value="RCE-HawkEye/1.1.1">
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    ...
                                    <div class="checkbox-grid">
                                        <label class="checkbox-label">
                                            <input type="checkbox" id="settingsPreferHTTPS" checked>
                                            <span data-i18n="option.preferHTTPS">Prefer HTTPS</span>
                                        </label>
                                        <label class="checkbox-label">
                                            <input type="checkbox" id="settingsNoHTTPS">
                                            <span data-i18n="option.noHTTPS">Disable HTTPS</span>
                                        </label>
                                        <label class="checkbox-label">
                                            <input type="checkbox" id="settingsVerifySSL">
                                            <span data-i18n="option.verifySSL">Verify SSL</span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div id="settings-payloads" class="settings-panel">
                    <div class="settings-card glass-card">
                        <div class="settings-card-header">
                            ...
                            <h3 data-i18n="config.payloads">Payload Settings</h3>
                        </div>
                        <div class="settings-card-body">
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="payload.targetOS">Target OS</label>
                                    <select id="settingsTargetOS" class="input-field">
                            ...
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    ...
                                    <div class="tech-stack-grid">
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="php" checked> PHP</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="jsp" checked> JSP/Java</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="asp" checked> ASP</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="aspx" checked> ASPX/.NET</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="python" checked> Python</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="nodejs" checked> Node.js</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="ruby"> Ruby</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="go"> Go</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="perl"> Perl</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="lua"> Lua</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="template" checked> SSTI</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsTechStack" value="coldfusion"> ColdFusion</label>
                                    </div>
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    ...
                                    <div class="checkbox-grid">
                                        <label class="checkbox-label"><input type="checkbox" name="settingsPayloadType" value="echo" checked> Echo Based</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsPayloadType" value="time" checked> Time Based</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsPayloadType" value="code" checked> Code Exec</label>
                                        <label class="checkbox-label"><input type="checkbox" name="settingsPayloadType" value="dns"> DNS Exfil</label>
                                    </div>
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    ...
                                    <textarea id="settingsCustomPayloads" class="input-field textarea" rows="4" placeholder="Enter custom payloads, one per line"></textarea>
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    <label data-i18n="payload.wordlist">Custom Wordlist</label>
                                    <input type="text" id="settingsCustomWordlist" class="input-field" placeholder="/path/to/wordlist.txt">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="settings-advanced" class="settings-panel">
                    <div class="settings-card glass-card">
                        <div class="settings-card-header">
                            ...
                            <h3 data-i18n="config.advanced">Advanced Settings</h3>
                        </div>
                        <div class="settings-card-body">
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    <label data-i18n="crawl.options">Crawler Settings</label>
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="crawler.depth">Crawl Depth</label>
                                    <input type="number" id="settingsCrawlDepth" class="input-field" value="2" min="1" max="10">
                                </div>
                                <div class="setting-item">
                                    <label data-i18n="crawler.maxPages">Max Pages</label>
                                    <input type="number" id="settingsCrawlPages" class="input-field" value="100" min="1" max="1000">
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    <label data-i18n="dirscan.options">Directory Scan Settings</label>
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="dirscan.threads">Threads</label>
                                    <input type="number" id="settingsDirThreads" class="input-field" value="10" min="1" max="100">
                                </div>
                                <div class="setting-item">
                                    <label data-i18n="dirscan.filterStatus">Status Filter</label>
                                    <input type="text" id="settingsDirFilterStatus" class="input-field" value="200" placeholder="200,301,302">
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="dirscan.filterExt">Extension Filter</label>
                                    <input type="text" id="settingsDirFilterExt" class="input-field" placeholder="php,asp,!jpg,!png">
                                </div>
                                <div class="setting-item">
                                    <label data-i18n="dirscan.filterPattern">Pattern Filter</label>
                                    <input type="text" id="settingsDirFilterPattern" class="input-field" placeholder="admin*,*config*">
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="dirscan.wordlist">Custom Wordlist</label>
                                    <input type="text" id="settingsDirWordlist" class="input-field" placeholder="/path/to/wordlist.txt">
                                </div>
                                <div class="setting-item">
                                    <label data-i18n="dirscan.archiveThreshold">Archive Threshold</label>
                                    <input type="number" id="settingsArchiveThreshold" class="input-field" value="30" min="1" max="100">
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item full-width">
                                    <label data-i18n="output.settings">Output Settings</label>
                                </div>
                            </div>
                            <div class="setting-row">
                                <div class="setting-item">
                                    <label data-i18n="output.format">Format</label>
                                    <select id="settingsOutputFormat" class="input-field">
                                        <option value="html">HTML</option>
                                        <option value="json">JSON</option>
                                        <option value="md">Markdown</option>
                                ...
                                <div class="setting-item">
                                    <label data-i18n="output.dir">Output Directory</label>
                                    <input type="text" id="settingsOutputDir" class="input-field" value="./reports">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            function initApp() {
                ...
                try {
                    ...
                    if (typeof loadStats === 'function') {
                        console.log('[DEBUG] Calling loadStats');
                        loadStats();
                    }
                    if (typeof loadSystemStatus === 'function') {
                        console.log('[DEBUG] Calling loadSystemStatus');
                        loadSystemStatus();
                    }
                    if (typeof loadHistory === 'function') {
                        console.log('[DEBUG] Calling loadHistory');
                        loadHistory();
                    } else {
                        console.error('[DEBUG] loadHistory function not found!');
                    }
                    if (typeof loadReports === 'function') {
                        console.log('[DEBUG] Calling loadReports');
                        loadReports();
                    }
